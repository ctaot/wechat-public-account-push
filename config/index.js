export const USER_CONFIG = {
  ...
  // 如果你非要填这里也行。脚本也能运行
  APP_ID: "wx730fdf146b008b07",
  
  // 公众号APP_SECRET
  // 建议不要填这里，请使用文档中github secret的方法进行保密配置，保护您的隐私安全。
  // 如果你非要填这里也行。脚本也能运行
  APP_SECRET: "80ec89cbab27c51b8a26590c2c6525fd",
  ...
  USERS: [
    ...
    },
    {
      ...
      name: "涛",
      // 扫码关注你的微信测试号后生成的一段字符串，在测试号后台能看到
      id: "orrqs6Q8Ehbrjavp0UPz50F5K0CM",
      // 你想对他发送的模板消息的模板ID
      useTemplateId: "Rvh-uq9cpm_7EyedfsVvpS_udYWmJ0wf7AIZBd8HS9M",
      // 所在省份
      province: "湖南",
      // 所在城市
      city: "岳阳",
  ...
  CALLBACK_TEMPLATE_ID: "2j7B36rcANrC5XkoO-2FGNPyIygO8D6MHNppnlOgMyg",
